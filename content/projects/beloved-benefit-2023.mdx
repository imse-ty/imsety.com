...
<ProjectCredits
  text="Shout out to everyone who I have worked with on this project and helped out along the way!"
  names={[
    { name: "Will", url: "https://tina.io/docs/reference/types/rich-text/" },
    { name: "Ted" }
  ]}
/>
